...
public class CultureEventVO {
	private String CODENAME = "1"; // 분류
	private String GUNAME = "1"; // 자치구
	private String TITLE = "1"; // 공연/행사명
	private String EVENTDATE = "1"; // 날짜/시간
	private String PLACE = "1"; // 장소
	private String ORG_NAME = "1"; // 기관명
	private String USE_TRGT = "1"; // 이용대상
	private String USE_FEE = "1"; // 이용요금
	private String PLAYER = "1"; // 출연자정보
	private String PROGRAM = "1"; // 프로그램소개
	private String ETC_DESC = "1"; // 기타내용
	private String ORG_LINK = "1"; // 홈페이지 주소
	private String MAIN_IMG = "1"; // 대표이미지
	private String RGSTDATE = "1"; // 신청일
	private String TICKET = "1"; // 시민/기관
	private String STRTDATE = "1"; // 시작일
	private String END_DATE = "1"; // 종료일
	private String THEMECODE = "1"; // 테마분류
	private String LOT = "1"; // 위도(X좌표)
	private String LAT = "1"; // 경도(Y좌표)
	private String IS_FREE = "1"; // 유무료
	private String HMPG_ADDR = "1"; // 문화포털상세URL
